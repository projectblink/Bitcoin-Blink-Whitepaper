...
\subfile{sections/Theory/exchange}
...
\appendix
\section{Appendix}
\subfile{sections/Appendix/ihr}
\subfile{sections/Appendix/vdf}
\subfile{sections/Appendix/merklechain}
\subfile{sections/Appendix/ring}
\subfile{sections/Appendix/bandwidth}
\subfile{sections/Appendix/election}
\subfile{sections/Appendix/block}
\subfile{sections/Appendix/fork}
\subfile{sections/Appendix/hash-reward}
\subfile{sections/Appendix/network graph}
\subfile{sections/Appendix/routing path}
\subfile{sections/Appendix/rent}
\subfile{sections/Appendix/stake-req}
\subfile{sections/Appendix/tax}
\subfile{sections/Appendix/exchange}
\subfile{sections/Appendix/dao}
