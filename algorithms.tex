...
\tcc{Return the route}
\If{len(routes) $>$ 0}{\textbf{return} (routes)\;}\lElse{\textbf{return} None\;}}}
\end{algorithm}
...
outputScript\_claim = codepart + pubKey + num2bin(this.token_a,8) + num2bin(current\_exchange\_rate\_value,8) + num2bin(tds, 8)\;
