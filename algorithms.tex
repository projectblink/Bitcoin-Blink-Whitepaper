...
\scriptsize \vspace{-2mm} Purva Choudhari, Ajay Joshua\thanks{ajay@bitcoinblink.org}\vspace{-14mm}}
\date{\scriptsize \today \hspace{0.5mm} (Genesis Version) \vspace{-4mm}}
...
\scriptsize
\begin{abstract}
\noindent \textbf{Disclaimer :} The below psedocodes provide basic instructions for the implementation of bitcoin blink protocols. It is constantly reviewed and updated by core-programmers and co-authors.
\end{abstract}
\begin{algorithm}[h]
\scriptsize
\DontPrintSemicolon
